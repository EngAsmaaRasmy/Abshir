...
class RoleController extends Controller
{
    ...
    {
         $this->middleware('permission:عرض الصلاحيات|إضافة صلاحية|تعديل صلاحية|حذف صلاحية', ['only' => ['index','store']]);
    ...
    {
        $roles = Role::orderBy('id','DESC')->paginate(PAGINATION);
    ...
    public function addPermission(Request $request)
    {
        ...
        return redirect()->route('get.add.role')
