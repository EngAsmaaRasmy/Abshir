                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    @enderror
                                    <form class="form-horizontal form-simple" method="post" action="{{route("user.login")}}" novalidate>
                                        @csrf
                                        <fieldset class="form-group position-relative has-icon-left mb-0">
                                            <input type="text" class="form-control" id="name" placeholder="الاسم " name="name" value="{{old("name")}}" required>
