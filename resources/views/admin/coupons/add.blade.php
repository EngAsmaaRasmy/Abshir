            ...
            <div class="content-body">
                ...
                <div class="card form-card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">اضافه كوبون</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            @include('alert.error')
                            <form class="form" method="post" action="{{ route('coupon.save') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="projectinput1"
                                                    ...
                                                    placeholder="نسبة الخصم" name="percentage">
                                                @error('percentage')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="projectinput1"
                                                    ...
                                                    placeholder="مبلغ الخصم" name="value">
                                                @error('value')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="projectinput1"
                                                    ...
                                                    placeholder="العدد المسموح" name="max_count">
                                                @error('max_count')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="expire_date"
                                                    ...
                                                    data-title="Date Fixed" data-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="projectinput1"
                                                    ...
                                                    placeholder="الحد الادنى للطلب" name="minimum_order">
                                                @error('minimum_order')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
