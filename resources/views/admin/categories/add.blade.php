                ...
                <div class="card form-card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            @include('alert.error')
                            <form class="form" method="post" action="{{ route('category.save') }}"
                                ...
                                <div class="form-body">
                                    ...
                                    <h4 class="form-section"><i class="la la-paperclip"></i> ايقونه القسم عربي</h4>

                                    <div class="form-group">
                                        <label> برجاء اختيار ايقونة القسم عربي</label>
                                    ...
                                    <h4 class="form-section"><i class="la la-paperclip"></i> ايقونه القسم إنجليزي</h4>

                                    <div class="form-group">
                                        <label> برجاء اختيار ايقونة القسم إنجليزي</label>
                                        <label class="file center-block">
