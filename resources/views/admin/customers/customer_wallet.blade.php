        ...
        <div class="content-body">
            ...
            <div class="card form-card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-form">تعديل محفظة العميل</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        @include("alert.error")
                        <form class="form" method="post" action="{{route("customer.wallet.update")}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-actions">
                                    <a href="{{route("customers.index")}}" type="button" class="btn btn-warning mr-1"
                                        style="color: white">
