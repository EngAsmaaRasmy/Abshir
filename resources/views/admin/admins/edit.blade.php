                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{route("admin.update",$admin->id)}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    <h4 class="form-section"><i class="ft-grid"></i> معلومات المستخدم</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="projectinput1">الاسم  </label>
                                                <input type="text" id="projectinput1" class="form-control @error("name") is-invalid @enderror"
                                                       placeholder="الاسم  " value="{{$admin->name}}" name="name">
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="projectinput2" class="form-control @error("email") is-invalid @enderror"
                                                       placeholder="البريد الإلكتروني  " value="{{$admin->email}}" name="email">
                                                @error('email')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
