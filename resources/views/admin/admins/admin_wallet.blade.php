        ...
        <div class="content-body">
            ...
            <div class="card form-card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-form">تعديل محفظة الادمن</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        @include("alert.error")
                        <form class="form" method="post" action="{{route("admin.wallet.update")}}"
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="projectinput1" class="form-control @error(" value")
                                                is-invalid @enderror" placeholder="القيمه " name="value">
                                            @error('value')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-actions">
                                    <a href="{{route("admin.index")}}" type="button" class="btn btn-warning mr-1"
                                        style="color: white">
                            ...
                            <div class="table-responsive-sm">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>@if($wallet->user_type == "Admin")أدمن @else تطبيق @endif</td>
                                            <td>
                                ...
                                <ul class="pager pager-flat">
                                    ...
                                    <li class="{{$wallet_history->onFirstPage()?'disabled':" enabled"}}">
                                        <a href="{{$wallet_history->previousPageUrl()}}"
                                            onclick="{{$wallet_history->onFirstPage()?" return false;":""}}"><i
                                                class="ft-arrow-left"></i> السابق</a>
                                    </li>


                                    <li class="{{$wallet_history->hasMorePages()?'enabled':" disabled"}} ">
                                        <a href=" {{$wallet_history->nextPageUrl()}}"
                                        onclick="{{$wallet_history->hasMorePages()?"":"return false;"}}" >التالى <i
