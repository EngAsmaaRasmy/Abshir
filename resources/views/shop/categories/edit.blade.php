                ...
                <div class="card form-card" >
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            @include("alert.error")
                            <form class="form" method="post" action="{{route("shop.category.update",$category->id)}}" >
                                @csrf
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{$category->name_ar}}" type="text" id="projectinput1" class="form-control @error("name-ar") is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{$category->name_en}}" type="text" id="projectinput2" class="form-control @error("name-en") is-invalid @enderror"
