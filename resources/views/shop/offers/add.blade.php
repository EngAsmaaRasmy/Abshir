            ...
            <div class="content-body">
                ...
                <div class="card form-card" >
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">اضافه عرض على</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            @include("alert.error")
                            <form class="form" method="post" action="{{route("save.shop.offer",$size->id)}}" >
                                @csrf
                                <div class="form-body">
                                    <h4 class="form-section"><i class="fa fa-bullhorn"></i> معلومات العرض</h4>

                                  <div >
                                  <offer-component :types="'{{$types}}'"></offer-component>
                                  </div>
