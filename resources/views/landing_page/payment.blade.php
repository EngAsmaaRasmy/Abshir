...
<body>
    ...
    <section data-bs-version="5.1" class="header3 cid-t3V203Nyaf mbr-fullscreen" id="header3-9">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="navbar-buttons mbr-section-btn">
                    <a type="button" class="btn btn-sm btn-warning display-4" id="geidea_payment" onclick="pay()">Pay</a>
    ...
    <script>
        ...
        function pay(){
            var trip_id = '{{$trip->id}}'
            // console.log(trip);
            var cost = '{{ $trip->cost_after_discount }}';
            var customer_id = '{{ $trip->client_id }}';
            var driver_id = '{{ $trip->driver_id }}';
            cost = parseInt(cost);  
        ...
        function apiResponseِ(response){
            $.ajax({
                    url: "/response",
                    type: "POST",
                    data: function() {
